<x-bootstrap title="Home">
    <x-nav/>
    <div class="h-full w-full p-4 mx-auto bg-gray-100">
                ...
                <div class="container flex mx-auto">
                    <div class="flex">
                        ...
                        <form method="get" action="/" id="form">
                            ...
                            @endif
                            <div class="inline">
                                <input type="text" name="search" placeholder="Search..." class="px-4 py-2 w-80 mr-5 border-2 rounded"
                        ...
                        <div class="lg:inline-flex bg-gray-100 rounded-xl ml-10">
                            <x-filter-dropdown>
                                <x-slot name="trigger">
        ...
        <div class="w-full mx-auto pl-10 space-y-8">
            @foreach($products as $product)
                <div class="w-1/5 inline-block mr-10 bg-white rounded-xl shadow-xl p-2">
