        ...
        <header class="flex items-center justify-between" id="header">
            <div class="container flex mx-auto ">
                <div class="flex  rounded">
                    ...
                    <form method="get" action="/admin/products" id="form" class="flex">
                        @if(request('category'))
                        ...
                        <div class="inline">
                            <input type="text"
                                   name="search"
                                   placeholder="Search..."
                                   class="px-4 py-2 w-80 mr-2 border-2 rounded"
            ...
            <table class="w-full divide-y divide-gray-200" id="table">
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td class="px-4 py-4">
                            <div class="text-sm text-gray-900">{{Illuminate\Support\Str::limit($product->description, 50)}}</div>
                        </td>
                        <td class="px-4 py-4">
